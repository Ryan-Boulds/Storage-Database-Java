...
import view_inventory_tab.TableListPanel;
...
public class ImportDataTab extends javax.swing.JPanel {
    ...
    public ImportDataTab(javax.swing.JLabel statusLabel, ViewInventoryTab viewInventoryTab) {
        ...
        tableListPanel = new TableListPanel(viewInventoryTab);
        ...
        backButton.addActionListener(e -> {
            if (viewInventoryTab != null) {
                viewInventoryTab.showMainView();
                java.util.logging.Logger.getLogger(ImportDataTab.class.getName()).log(
